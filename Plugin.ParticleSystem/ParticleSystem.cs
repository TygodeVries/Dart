...
namespace Runtime.Graphics
{
    ...
    public class ParticleSystemManager : Renderers.Renderer, IUpdatableManager
    {
        ...
        public override void Render()
        {
            ...
            {
                shader?.SetMatrix4("uView", Matrix4.MultiplicativeIdentity);
                shader?.SetMatrix4("uProjection", Matrix4.MultiplicativeIdentity);
            }
            ...
            {
                shader?.SetMatrix4("uModel", Matrix4.MultiplicativeIdentity);
            }
        ...
        public override void OnLoad()
        {
            ...
            compute.Check();
            GL.TexImage2D(TextureTarget.Texture2d, 0, InternalFormat.Rgba16f, 256, 2 * number_of_slots, 0, PixelFormat.Rgba, PixelType.Byte, (nint)0);
            compute.Check();
        }
        float t = 0;
        /// <summary>
        ...
        public override void Update()
        {
            ...
            float simulated_time = steps / 100f;
